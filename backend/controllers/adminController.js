...
const appointmentCancel = async (req, res) => {
    try {
        ...
        console.log(await doctorModel.findByIdAndUpdate(docId, { slots_booked }))
...
export { addDoctor,loginAdmin,allDoctors,changeAvailability,doctorList,appointmentAdmin,appointmentCancel,adminDashboard };
